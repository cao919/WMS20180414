<%@ Page Title="Users" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Cao.WMS.Web.caowms.Users.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="UPower" HeaderText="UPower" SortExpression="UPower" ItemStyle-HorizontalAlign="Center"  /> 
		...
		<asp:BoundField DataField="UAddress" HeaderText="UAddress" SortExpression="UAddress" ItemStyle-HorizontalAlign="Center"  /> 
		...
		<asp:BoundField DataField="UDep" HeaderText="UDep" SortExpression="UDep" ItemStyle-HorizontalAlign="Center"  /> 

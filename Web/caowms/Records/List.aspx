...
<!--Title -->
		...
		<asp:BoundField DataField="RGID" HeaderText="SKU编号" SortExpression="RGID" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="RWID" HeaderText="存储仓库编号" SortExpression="RWID" ItemStyle-HorizontalAlign="Center"  /> 

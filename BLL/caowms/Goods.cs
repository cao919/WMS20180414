...
namespace Cao.WMS.BLL.caowms
{
	...
	{
		private readonly Cao.WMS.DAL.caowms.Goods dal=new Cao.WMS.DAL.caowms.Goods();
		public Goods()
		{}
		#region  BasicMethod
		/// <summary>
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Cao.WMS.Model.caowms.Goods GetModelByCache(string GID)
		{
			...
			return (Cao.WMS.Model.caowms.Goods)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Cao.WMS.Model.caowms.Goods> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Cao.WMS.Model.caowms.Goods> DataTableToList(DataTable dt)
		{
			List<Cao.WMS.Model.caowms.Goods> modelList = new List<Cao.WMS.Model.caowms.Goods>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Cao.WMS.Model.caowms.Goods model;

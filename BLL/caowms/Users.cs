...
namespace Cao.WMS.BLL.caowms
{
	...
	{
		private readonly Cao.WMS.DAL.caowms.Users dal=new Cao.WMS.DAL.caowms.Users();
		public Users()
		{}
		#region  BasicMethod
		/// <summary>
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Cao.WMS.Model.caowms.Users GetModelByCache(string UID)
		{
			...
			return (Cao.WMS.Model.caowms.Users)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Cao.WMS.Model.caowms.Users> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Cao.WMS.Model.caowms.Users> DataTableToList(DataTable dt)
		{
			List<Cao.WMS.Model.caowms.Users> modelList = new List<Cao.WMS.Model.caowms.Users>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Cao.WMS.Model.caowms.Users model;
